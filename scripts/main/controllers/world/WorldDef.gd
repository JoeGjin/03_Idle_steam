...
@export var far_1_spwan_cooldown: float = 1.0
...
@export var far_2_spwan_cooldown: float = 1.0
...
@export var mid_0_texture: Array[Texture2D] = []
...
@export var mid_1_spwan_cooldown: float = 1.0
...
@export var mid_2_spwan_cooldown: float = 1.0
@export_range(0.0, 1.0, 0.01) var mid_2_spwan_randomness: float = 0.1


@export var front_0_texture: Array[Texture2D] = []
...
@export var front_1_spwan_cooldown: float = 1.0
...
@export var front_2_spwan_cooldown: float = 1.0
